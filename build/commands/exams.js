...
module.exports = {
    ...
    log: false,
    usage: "`!exams`",
    description: "Displays examination information for each of the user's course roles.",
    execute(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (message.guild) {
                ...
                if (examData.length > MAX_EMBED)
                    message.reply("too many arguments to process. Try reducing the amount of course roles you have.");
                    ...
                    message.reply("couldn't find exam data for your course roles for the current trimister."); // none of the user courses were valid
            }
